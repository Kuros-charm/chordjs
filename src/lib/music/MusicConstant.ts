...
export type MusicActionAbsTime = { time: number, musicSound: MusicSound }
export type MusicActionRelTime = number | MusicSound
export type MusicNote = string
export type MusicChord = string[]
export type MusicSound = { sound: string | MusicChord, length: string }

export const SOFA_NAME = ['d', 'r', 'm', 'f', 's', 'l', 't']

export const MIDI_NUM_NAMES = ["C_1", "C#_1", "D_1", "D#_1", "E_1", "F_1", "F#_1", "G_1", "G#_1", "A_1", "A#_1", "B_1",
...
export const MIDI_FLAT_NAMES = ['C_1', 'Db_1', 'D_1', 'Eb_1', 'Fb_1', 'F_1', 'Gb_1', 'G_1', 'Ab_1', 'A_1', 'Bb_1', 'Cb0',
...
export const MAJOR_CHORD = [0, 7, 12, 16] // 0, 4, 7, 10, 13, 16
export const MINOR_CHORD = [0, 7, 12, 15] // 0 ,3, 7, 11


export const DIMINISHED_CHORD = [0, 3, 6] //[0, 3, 6]
export const AUGMENTED_CHORD = [0, 4, 8] //[0, 4, 8]
